...
const verificationAnswers = [
  { id: 'wife_shopping', label: '🛍️ Munnu', detail: 'When she was shopping at Lulu Mall' },
  { id: 'famous_quote', label: '📜 A Philosopher', detail: 'In some ancient, dusty book' },
  { id: 'arshu_road_trip', label: '🚗 Arshu', detail: 'When he was going on a road trip with cousins' },
  { id: 'bank_balance', label: "💳 Arshu's Bank Account", detail: 'Whenever Munnu opens a shopping app' },
];
...
export default function PuzzlePage() {
  ...
  const verifyAnswer = () => {
    ...
    if (selectedAnswer !== 'arshu_road_trip') {
      setAnswerFeedback({
        type: 'error',
        message: '❌ Nope! That is not it. Think of who becomes a deep philosopher during road trips! 🚘💭',
      });
      return;
    }
            ...
            <>
              ...
              <div className="blue-panel-header relative overflow-hidden px-5 py-5 text-left sm:px-7 sm:py-6">
                ...
                <div className="relative">
                  ...
                  >
                    Get it right or face the wrath of Munnu! 😡😂
                  </p>
                </div>
              </div>
              ...
              <div className="p-4 sm:p-6" style={{ color: '#2C1A0E' }}>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    >
                      "everything is temporary," who said this, and when? 🤔
                    </h2>
                  </div>
                </div>
                ...
                <div className="mt-4 grid gap-2.5 sm:grid-cols-2 sm:gap-3">
                  {verificationAnswers.map((answer) => {
                    ...
                    return (
                      <label
                        key={answer.id}
                        className={`answer-option relative flex min-h-[4.5rem] items-center gap-3 rounded-2xl p-4 text-left transition duration-200 ${
