    ...
    <PageShell>
      <div className="mx-auto max-w-5xl">
        ...
        <GlassCard className="mx-auto mt-8 max-w-3xl p-6 text-center">
          <p className="font-script text-4xl text-rose-700 dark:text-pink-100 sm:text-5xl">
            <Typewriter
              speed={55}
          ...
          {status ? (
            <p className="mt-4 text-sm font-bold text-rose-600 dark:text-pink-100">{status}</p>
          ) : null}
        </GlassCard>
      </div>
    </PageShell>
